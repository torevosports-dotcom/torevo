...
export const categoryMeta: Record<EventCategory, { label: string; emoji: string; color: string; bg: string; image: ImageSourcePropType }> = {
  ...
  basketball:   { label: 'Basketball',   emoji: '🏀', color: '#0A0A0A', bg: '#F2F2F2', image: require('../assets/sports/basketball_cover.jpg') },
  ...
  kabaddi:      { label: 'Kabaddi',      emoji: '🤼', color: '#0A0A0A', bg: '#F2F2F2', image: require('../assets/sports/kabaddi_cover.jpg') },
  ...
  pickleball:   { label: 'Pickleball',   emoji: '🏓', color: '#0A0A0A', bg: '#F2F2F2', image: require('../assets/sports/pickleball_cover.jpg') },
